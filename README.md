...
**[1.2.32 (202)](https://github.com/txrx13/meduzavpn/releases/tag/v1.2.32-202)** brings the app to Android TV — every screen driven with the remote, ULTRA verified on a live service — opens the VPN list instantly from a local cache and keeps it still while refreshing, lets you confirm a television's or router's sign-in from your phone with a QR code, names each signed-in device by what it is, and ships MeduzaVPN for OpenWrt routers: a package for x86/64, Filogic and MT7621 with a LuCI page, plus static daemons for arm64, armv7, mips and mipsel, ULTRA included.
...
**Release channels:** direct app and CLI downloads, the Windows installer and the signed apt/dnf repositories are build 198. Google Play carries 1.2.32 (202) on the production track. iOS and macOS have 1.2.32 (202) in TestFlight; the Apple TV app 1.0.0 (1) is in TestFlight for the internal group; the Apple public listings still show 1.2.25 until a new version is submitted and reviewed. Router packages carry daemon 1.2.31-196 -- the daemon has not changed since --  and listed under [Routers and televisions](#routers).
...
**Repository snapshot checked 19 September 2026: 1.2.32-202.** The GUI is available for x86-64; the CLI and service are available for x86-64 and ARM64. Both apt/dnf repositories and [direct packages](#downloads) are current.
...
**Release status, checked 19 September 2026:** direct downloads, the Windows installer and the signed Linux repositories serve 1.2.32 (202). Google Play 1.2.32 (202) is on the production track. iOS and macOS 1.2.32 (202) are in TestFlight for existing internal testers; Apple TV 1.0.0 (1) is in TestFlight for the internal group. Public Apple store releases are separate from TestFlight.

### Applications and testing

| Platform / channel | Current release | Download |
|---|---|---|
| iOS public store | 1.2.25 on sale; 1.2.32 (202) is in TestFlight | [App Store](https://apps.apple.com/us/app/meduzavpn/id6755959724) |
...
| iOS beta | 1.2.32 (202) | TestFlight; existing internal tester groups |
| macOS beta | 1.2.32 (202) | TestFlight; existing tester groups |
| Android public store | 1.2.32 (202), production track; phones, tablets and Android TV | [Google Play](https://play.google.com/store/apps/details?id=app.meduzavpn) |
...
| macOS direct installer | 1.2.32 (202) | [Signed, notarized DMG](https://meduzavpn.com/download/macos) |
| Android direct installer | 1.2.32 (202); installs on Android TV and Fire TV as well | [Release-signed APK](https://meduzavpn.com/download/android) |
| Windows graphical app | 1.2.32 | [Windows installer](https://meduzavpn.com/download/windows) |
| Linux graphical app | 1.2.32-202, x86-64 | [DEB](https://meduzavpn.com/download/linux-desktop-deb) · [RPM](https://meduzavpn.com/download/linux-desktop-rpm) |

### Command line and Linux service

| Platform | Current release | Download |
|---|---|---|
| Linux CLI + daemon | 1.2.32-202 | [DEB](https://meduzavpn.com/download/linux-deb) · [RPM](https://meduzavpn.com/download/linux-rpm) · [tar.gz](https://meduzavpn.com/download/linux-tar) |
| macOS CLI | 1.2.32-202 | [Universal archive](https://meduzavpn.com/download/cli-macos) |
| Windows CLI | 1.2.32-202 | [Windows archive](https://meduzavpn.com/download/cli-windows) |
...
```bash
curl -fsSLO https://github.com/txrx13/meduzavpn/releases/download/v1.2.32-202/SHA256SUMS
