...
**Repository snapshot checked 20 September 2026: 1.2.32-203.** The GUI is available for x86-64; the CLI and service are available for x86-64 and ARM64. Both apt/dnf repositories and [direct packages](#downloads) are current.
...
| iOS beta | 1.2.33 (207) | TestFlight; existing internal tester groups |
| macOS beta | 1.2.33 (207) | TestFlight; existing tester groups |
| Android public store | 1.2.33 (207), production track; phones, tablets and Android TV | [Google Play](https://play.google.com/store/apps/details?id=app.meduzavpn) |
...
| macOS direct installer | 1.2.33 (207) | [Signed, notarized DMG](https://meduzavpn.com/download/macos) |
| Android direct installer | 1.2.33 (207); installs on Android TV and Fire TV as well | [Release-signed APK](https://meduzavpn.com/download/android) |
| Windows graphical app | 1.2.33 | [Windows installer](https://meduzavpn.com/download/windows) |
| Linux graphical app | 1.2.33-207, x86-64 | [DEB](https://meduzavpn.com/download/linux-desktop-deb) · [RPM](https://meduzavpn.com/download/linux-desktop-rpm) |
